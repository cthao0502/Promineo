...
class FetchJeepTest extends FetchJeepTestSupport{
  ...
  class TestsThatDoNotPolluteTheApplicationContext extends FetchJeepTestSupport {
    ...
    void testThatAnErrorMEssageIsReturnedWhenAnUnknownTrimIsSupplied() {
      ...
      assertErroMessageValid(error, HttpStatus.NOT_FOUND);
    }
   ...
   // Given: a valid model, trim and URI
      ...
      //Then: a request parameters are invalid (400) status code is returned
      assertThat(response.getStatusCode()).isEqualTo(HttpStatus.BAD_REQUEST);
      
      // And: an error message is returned
      Map<String, Object> error = response.getBody();
      
      assertErroMessageValid(error, HttpStatus.BAD_REQUEST);
    }
  }
  ...
  class TestsThatPolluteTheApplicationContext extends FetchJeepTestSupport{
    ...
    void testThatAnUnplannedErrorResultsInA500Status() {
      ...
      assertErroMessageValid(error, HttpStatus.INTERNAL_SERVER_ERROR);
    }
