...
class FetchJeepTest {
  ...
  class TestsThatDoNotPolluteTheApplicationContext extends FetchJeepTestSupport{
    ...
    @Test
    void testThatJeepsAreReturnedWhenAValaidModelAndTrimAreSupplied() {
  ...
  static Stream<Arguments> parametersForInvalidInput() {
    ...
    return Stream.of(
         ...
         arguments("INVALID", "Sport", "Model isnot enum value")
    // @formatter:on
    );
 }
  ...
  class TestsThatPolluteTheApplicationContext extends FetchJeepTestSupport{
    @MockBean
    private JeepSalesService jeepSaleService;
    ...
    void testThatAnUnplannedErrorResultsInA500Status() {
      ...
      doThrow(new RuntimeException("Ouch!")).when(jeepSaleService)
